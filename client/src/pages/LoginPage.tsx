      ...
      <div className="relative w-full max-w-md">
        <div className="glass-card rounded-3xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-600 text-center">Teach kids responsibility through earning and managing pocket money</p>
          </div>

          {/* Google Sign-In Button */}
          <button
            onClick={handleGoogleSignIn}
            className="w-full ios-button bg-white text-gray-900 py-4 px-6 flex items-center justify-center gap-3 hover:bg-gray-50 transition-all"
          >
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white/80 text-gray-500 rounded-full">Secure authentication</span>
            </div>
          </div>
